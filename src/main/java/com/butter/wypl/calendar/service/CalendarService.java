...
//					diffTime = Duration.between(schedule.getStartDateTime(), schedule.getEndDateTime()).toMinutes();
//				} else if (date.isEqual(scheduleStartDate)) {
//					diffTime = Duration.between(schedule.getStartDateTime(),
...
//							LocalDateTime.of(scheduleEndDate, LocalTime.of(0, 0)), schedule.getEndDateTime()).toMinutes();
//				} else {
//					diffTime = 24 * 60;
//				}
//
